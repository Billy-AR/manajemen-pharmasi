...
function LoginForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Login gagal. Periksa kembali email dan sandi Anda.";
      setError(message);
    } finally {
      setLoading(null);
    }
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Gagal terhubung dengan Google.";
      setError(message);
    } finally {
      setLoading(null);
    }
    ...
    <main className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden font-sans text-slate-900">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex h-23 w-25 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/20 mb-4">
            <Image src={"https://i.pinimg.com/736x/d0/51/0b/d0510b5cdaf19112b91febe4604d94f8.jpg"} width={90} height={0} alt="opal" className="rounded-lg" />
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Apotek An Nisa</h1>
          <p className="text-sm text-slate-500 mt-2">Masuk untuk mengelola inventaris & penjualan.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-xs font-medium text-emerald-600 hover:text-emerald-500 transition-colors">
                  Lupa password?
                </button>
              </div>
              <div className="relative">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-2 text-xs uppercase tracking-wider text-slate-500">Atau masuk dengan</span>
              </div>
            </div>
        ...
        {/* Simple Footer */}
        <p className="mt-6 text-center text-xs text-slate-400">&copy; 2025 Apotek Cloud System. Protected.</p>
      </div>
    </main>
  );
}
